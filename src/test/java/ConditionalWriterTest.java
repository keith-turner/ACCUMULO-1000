...
public class ConditionalWriterTest {
  ...
  public void testBadColVis() throws Exception {
    ...
    Assert.assertEquals(ConditionalWriter.Status.VISERRED, cw.write(cm2).status);
    ...
    Assert.assertEquals(ConditionalWriter.Status.VISERRED, cw.write(cm3).status);
    ...
    Assert.assertEquals(ConditionalWriter.Status.VISERRED, cw.write(cm4).status);
    ...
    Assert.assertEquals(ConditionalWriter.Status.VISERRED, cw.write(cm5).status);
    ...
    Assert.assertEquals(ConditionalWriter.Status.VISERRED, cw.write(cm6).status);
    ...
    Assert.assertEquals(ConditionalWriter.Status.VISERRED, cw.write(cm7).status);
  }
